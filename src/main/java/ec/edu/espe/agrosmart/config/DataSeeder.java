...
public class DataSeeder implements CommandLineRunner {
    ...
    public DataSeeder(ProductoRepository productoRepository, ProductoService productoService) {
    ...
    public void run(String... args) throws Exception {
        if (productoRepository.count() == 0) {
            List<ProductoEntity> productos = List.of(
                ...
                new ProductoEntity("Rosas de Exportacion", new BigDecimal("18.50"), 150, "Flores", "ventas@rosas.com,export@rosas.com"),
                new ProductoEntity("Orquideas Blancas", new BigDecimal("25.00"), 80, "Flores", "contacto@orquideas.ec"),
                new ProductoEntity("Girasoles ", new BigDecimal("12.00"), 200, "Flores", "info@girasoles.com,pedidos@girasoles.com"),
